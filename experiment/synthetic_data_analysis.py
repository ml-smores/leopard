...
root_path = "/Users/hy/inf/Study/CS/Projects_Codes_Data/Data/Data_white/real_data/"
exp_path = "" #"20kc_20prac_withlearning_2500stu/"
...
def main(threshold=0.6, plot=True, metrics_correlation=False, generate_whites=False): #example_data/example1.csv"
    if generate_whites:
        ...
        whites = []
        aucs = []
        standard_metrics = {"score":[], "effort":[], "accuracy":[], "fmeasure":[],"log_loss":[], "rmse":[], "r2":[], "auc":[]}
        for df in dfs:
        ...
        df_metrics = pd.DataFrame({"chapter":chapters, "score":standard_metrics["score"], "effort":standard_metrics["effort"], "auc":standard_metrics["auc"],
                                   ...
                                   "rmse": standard_metrics["rmse"], "r2": standard_metrics["r2"]}, columns=["chapter","score","effort","auc","accuracy","fmeasure","log_loss","rmse","r2"])
        df_metrics.to_csv(root_path + exp_path + "metrics.csv", index=False, columns=["chapter","score","effort","auc","accuracy","fmeasure","log_loss","rmse","r2"])
